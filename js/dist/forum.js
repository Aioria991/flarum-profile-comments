...
/* harmony import */ var _utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/getTranslation */ "./src/forum/utils/getTranslation.ts");
/* harmony import */ var _components_LeaveCommentArea__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/LeaveCommentArea */ "./src/forum/components/LeaveCommentArea.tsx");
...
var UserCommentsPage = /*#__PURE__*/function (_UserPage) {
  ...
  _proto.getUserComments = /*#__PURE__*/function () {
    var _getUserComments = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(page, pageSize) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().store.find('user_comments', paginationParams);
          case 6:
    ...
    function getUserComments(_x, _x2) {
      return _getUserComments.apply(this, arguments);
    }
    return getUserComments;
  }();
  _proto.createComment = /*#__PURE__*/function () {
    var _createComment = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2(uid, title, comment) {
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().request({
              method: 'POST',
              url: flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().forum.attribute('apiUrl') + "/user_comments",
              body: {
                data: {
                  attributes: {
                    comment_title: title,
          ...
          case 4:
            ...
            flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().alerts.show({
              type: 'success'
            }, (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__.getTranslation)('forum', 'alertCommentCreated'));
            _context2.next = 11;
            break;
          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](1);
            flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().alerts.show('error', (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__.getTranslation)('forum', 'alertCommentError'));
          case 11:
            _context2.prev = 11;
            this.loading = false;
    ...
    function createComment(_x3, _x4, _x5) {
  ...
  _proto.view = function view() {
    var _this = this;
    var meta = this.comments && this.comments.payload.meta;
    if (!(flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().session).user) {
      ...
      }, m("h2", null, flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().translator.trans('justoverclock-profile-comments.forum.commentsPageLink'))), m("div", null, (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__.getTranslation)('forum', 'pleaseLoginMessage')))))));
    }
    return m("div", {
      className: "UserPage profile-comments-page"
    }, this.user ? m("div", {
      className: "container"
    }, m("div", {
      className: "sideNavContainer"
      ...
      className: "profile-comment-actions"
    }, m("h2", null, flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().translator.trans('justoverclock-profile-comments.forum.commentsPageLink'))), this.user.id().toString() !== (flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().session).user.data.id ? m(_components_LeaveCommentArea__WEBPACK_IMPORTED_MODULE_10__["default"], {
      onInteraction: function onInteraction() {
        flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().modal.show(_components_AddCommentModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
          ...
          createComment: _this.createComment,
          refreshComments: _this.getUserComments.bind(_this)
        });
      },
      userAvatarUrl: (flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().session).user.data.attributes.avatarUrl || "https://placehold.co/25?text=" + flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().session.user.data.attributes.username.charAt(0).toUpperCase(),
      placeholder: (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__.getTranslation)('forum', 'leaveComment')
    }) : m(_components_LeaveCommentArea__WEBPACK_IMPORTED_MODULE_10__["default"], {
      userAvatarUrl: (flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().session).user.data.attributes.avatarUrl || "https://placehold.co/25?text=" + flarum_forum_app__WEBPACK_IMPORTED_MODULE_5___default().session.user.data.attributes.username.charAt(0).toUpperCase(),
      placeholder: (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__.getTranslation)('forum', 'cantComment')
    }), m("div", null, this.comments && this.comments.payload.data.map(function (comment) {
      ...
      className: "profile-comment-pagination"
    }, m("button", {
      "class": "Button",
      disabled: this.currentPage === 1,
      onclick: function onclick() {
        if (_this.currentPage > 1) {
          _this.getUserComments(_this.currentPage - 1);
        }
      }
    }, (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__.getTranslation)('forum', 'previousPage')), m("button", {
      "class": "Button",
    ...
    }, (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_9__.getTranslation)('forum', 'nextPage'))))))) : m((flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_4___default()), {
      display: "block"
    }));
  };
...
/* harmony import */ var _utils_getTranslation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/getTranslation */ "./src/forum/utils/getTranslation.ts");
...
var AddCommentModal = /*#__PURE__*/function (_Modal) {
  function AddCommentModal() {
    ...
    _this.commentTitle = flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()('');
    _this.comment = flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()('');
    return _this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(AddCommentModal, _Modal);
  ...
  _proto.title = function title() {
    return (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_4__.getTranslation)('forum', 'createCommentModalTitle');
  };
  _proto.submitComment = /*#__PURE__*/function () {
    var _submitComment = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(e) {
      var title, comment;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return this.attrs.createComment(this.attrs.userId, title, comment);
          case 6:
            this.loading = false;
  ...
  _proto.content = function content() {
    ...
    return m("div", null, m("form", {
      ...
      name: "comment_title",
      type: "text",
      placeholder: (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_4__.getTranslation)('forum', 'placeholderCommentTitle'),
      "aria-label": "comment_title",
      value: this.commentTitle(),
      oninput: function oninput(e) {
        return _this2.commentTitle(e.target.value);
      }
    })), m("div", {
      className: "Form-group"
    }, m("textarea", {
      ...
      rows: 8,
      name: "comment",
      placeholder: (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_4__.getTranslation)('forum', 'placeholderComment'),
      value: this.comment(),
      oninput: function oninput(e) {
        return _this2.comment(e.target.value);
      }
    })), m("div", {
      className: "Form-group"
    }, m("button", {
    ...
    }, (0,_utils_getTranslation__WEBPACK_IMPORTED_MODULE_4__.getTranslation)('forum', 'leaveComment'))))));
  };
...
/***/ "./src/forum/components/LeaveCommentArea.tsx":
/*!***************************************************!*\
  !*** ./src/forum/components/LeaveCommentArea.tsx ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ LeaveCommentArea)
/* harmony export */ });
...
var LeaveCommentArea = /*#__PURE__*/function (_Component) {
  function LeaveCommentArea() {
    return _Component.apply(this, arguments) || this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(LeaveCommentArea, _Component);
  var _proto = LeaveCommentArea.prototype;
  _proto.oninit = function oninit(vnode) {
  ...
  _proto.view = function view(vnode) {
    return m("button", {
      onclick: this.attrs.onInteraction,
      ...
      loading: "lazy",
      src: this.attrs.userAvatarUrl,
      alt: ""
    }), this.attrs.placeholder));
  };
  return LeaveCommentArea;
}((flarum_common_Component__WEBPACK_IMPORTED_MODULE_1___default()));


/***/ }),

/***/ "./src/forum/components/NewProfileCommentNotification.tsx":
/*!****************************************************************!*\
  !*** ./src/forum/components/NewProfileCommentNotification.tsx ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ NewProfileCommentNotification)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
...
var NewProfileCommentNotification = /*#__PURE__*/function (_Notification) {
  function NewProfileCommentNotification() {
  ...
  _proto.href = function href() {
    if ((flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().session).user) {
      var _app$session;
      return flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().route.user((flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default()) == null || (_app$session = (flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().session)) == null ? void 0 : _app$session.user) + "/profile-comments";
    } else {
      return '#';
    }
  };
  ...
  return NewProfileCommentNotification;
...
var SingleComment = /*#__PURE__*/function (_Component) {
  ...
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(SingleComment, _Component);
  ...
  _proto.deleteComment = /*#__PURE__*/function () {
    var _deleteComment = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(commentId) {
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return flarum_forum_app__WEBPACK_IMPORTED_MODULE_4___default().request({
              method: 'DELETE',
              url: flarum_forum_app__WEBPACK_IMPORTED_MODULE_4___default().forum.attribute('apiUrl') + "/user-comment-delete/" + commentId
            });
          case 2:
            if (this.attrs.refreshComments) {
              this.attrs.refreshComments();
  ...
  _proto.view = function view(vnode) {
    ...
    }, m("div", null, this.attrs.relToUser.id.toString() === flarum_forum_app__WEBPACK_IMPORTED_MODULE_4___default().session.user.id() && m("button", {
      type: "button",
      onclick: function onclick() {
        return _this.deleteComment(_this.attrs.commentedBy.id);
      },
...
/* harmony import */ var _components_NewProfileCommentNotification__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/NewProfileCommentNotification */ "./src/forum/components/NewProfileCommentNotification.tsx");
/* harmony import */ var flarum_forum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! flarum/forum/components/NotificationGrid */ "flarum/forum/components/NotificationGrid");
/* harmony import */ var flarum_forum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6__);
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('justoverclock/profile-comments', function () {
  (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().notificationComponents).profileComment = _components_NewProfileCommentNotification__WEBPACK_IMPORTED_MODULE_5__["default"];
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_2__.extend)((flarum_forum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6___default().prototype), 'notificationTypes', function (items) {
    items.add('profileComment', {
      name: 'profileComment',
